...
// Traffic Chart
  ...
  if ($('#traffic-chart').length) {
    var chart = new Chartist.Line('#traffic-chart', {
      labels: ['Jan', 'Feb1', 'Mar', 'Apr', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
      series: [
      [13, 18, 35, 18, 25, 26, 22, 20, 18, 35, 18, 25],
      [15, 23, 15, 30, 20, 31, 15, 15, 23, 15, 30, 20],
      [25, 15, 38, 25, 15, 22, 30, 25, 15, 38, 25, 15]
      ]
    }, {
      low: 0,
      showArea: true,
...
/* Gauge Chart */
 ...
 // Chartist
  ...
  var chart = new Chart(ctx, {
        ...
        data: {
          labels: ["Jan", "Feb1", "Mar", "Jun", "Jul", "Aug", "Sep"],
          datasets: [{
